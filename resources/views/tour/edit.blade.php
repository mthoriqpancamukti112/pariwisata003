                                ...
                                <form action="{{ route('tour.update', $tour->id) }}" method="POST"
                                    ...
                                    <div class="m-5">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <img src="/images_wisata/{{ $tour->image }}" width="300px">
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="nama_wisata">Nama Wisata</label>
                                            <input type="text" name="nama_wisata" class="form-control"
                                                value="{{ $tour->nama_wisata }}">
                                        </div>
                                        <div class="form-group mb-3">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="fasilitas" class="form-control"
                                                value="{{ $tour->fasilitas }}">
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="lokasi">Lokasi</label>
                                            <textarea id="lokasi" name="lokasi" class="autosize-transition form-control">{{ $tour->lokasi }}</textarea>
                                        </div>
                                        <div class="form-group mb-3">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="jam_operasional" class="form-control"
                                                value="{{ $tour->jam_operasional }}">
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="deskripsi">Deskripsi</label>
                                            <input type="text" name="deskripsi" class="form-control"
                                                value="{{ $tour->deskripsi }}">
                                        </div>
